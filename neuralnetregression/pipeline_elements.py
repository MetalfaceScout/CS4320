...
class DataFrameSelector(sklearn.base.BaseEstimator, sklearn.base.TransformerMixin):
    ...
    def __init__(self, do_predictors=True, do_numerical=True):
        #Age,Gender,,,,,,,,,,,
        self.mCategoricalPredictors = ["Gender","Marital Status","Education Level","Occupation","Location","Policy Start Date","Customer Feedback","Smoking Status","Exercise Frequency","Property Type"]
        self.mNumericalPredictors = ["Age","Annual Income","Health Score","Vehicle Age", "Number of Dependents","Credit Score","Insurance Duration"]
