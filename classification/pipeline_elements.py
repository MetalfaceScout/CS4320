...
class DataFrameSelector(sklearn.base.BaseEstimator, sklearn.base.TransformerMixin):
    ...
    def __init__(self, do_predictors=True, do_numerical=True):
        # id,,,,,,,,,,,loan_status
        self.mCategoricalPredictors = ["person_home_ownership", "loan_intent","loan_grade","loan_amnt","cb_person_default_on_file"]
        self.mNumericalPredictors = ["person_emp_length","person_age","person_income","loan_int_rate","loan_percent_income","cb_person_cred_hist_length"]
        self.mLabels = []
